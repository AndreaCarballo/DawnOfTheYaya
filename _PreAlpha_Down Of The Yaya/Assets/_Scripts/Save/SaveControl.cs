...
public class SaveControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerMove = GameObject.FindGameObjectWithTag("Player").GetComponent<MovClick>();
    ...
    public void Save()
    {
        ...
        game.zone = playerMove.zone;
        game.time = playerMove.time;
    ...
    public void Load()
    {
        if (File.Exists(Application.persistentDataPath + "/SaveGame.dat"))
        {
            ...
            Game game = (Game)binary.Deserialize(file);
            file.Close();
            difficulty = game.difficulty;
            playerMove.zone = game.zone;
            playerMove.time = game.time;
